...
package { 'apparmor':
  ensure => '2.8.95~2430-0ubuntu5.3',
}
package { 'apport':
  ensure => '2.14.1-0ubuntu3.19',
}
package { 'apport-symptoms':
  ensure => '0.20',
}
package { 'apt':
  ensure => '1.0.1ubuntu2.12',
}
...
package { 'bash-completion':
  ensure => '1:2.1-4ubuntu0.1',
}
package { 'bc':
  ensure => '1.06.95-8ubuntu1',
}
package { 'bind9-host':
  ensure => '1:9.9.5.dfsg-3ubuntu0.8',
}
package { 'binutils':
  ensure => '2.24-5ubuntu14',
}
package { 'boto3':
  ensure => '1.3.0',
}
...
package { 'klibc-utils':
  ensure => '2.0.3-0ubuntu1',
}
package { 'kmod':
  ensure => '15-0ubuntu6',
}
package { 'kpartx':
  ensure => '0.4.9-3ubuntu7.11',
}
package { 'krb5-locales':
  ensure => '1.12+dfsg-2ubuntu5.2',
}
package { 'landscape-client':
...
package { 'libmysqlclient18':
  ensure => '5.5.47-0ubuntu0.14.04.1',
}
package { 'libncurses5':
...
package { 'linux-headers-3.13.0-85':
  ensure => '3.13.0-85.129',
}
package { 'linux-headers-3.13.0-85-generic':
  ensure => '3.13.0-85.129',
}
...
package { 'linux-image-3.13.0-85-generic':
  ensure => '3.13.0-85.129',
}
...
package { 'lsb-base':
  ensure => '4.1+Debian11ubuntu6',
}
package { 'lsb-release':
  ensure => '4.1+Debian11ubuntu6',
}
package { 'lshw':
  ensure => '02.16-2ubuntu1.3',
}
package { 'lsof':
...
package { 'ntp':
  ensure => '1:4.2.6.p5+dfsg-3ubuntu2.14.04.8',
}
package { 'ntpdate':
  ensure => '1:4.2.6.p5+dfsg-3ubuntu2.14.04.8',
}
...
package { 'pollinate':
  ensure => '4.7-0ubuntu1.4',
}
package { 'popularity-contest':
  ensure => '1.57ubuntu1',
}
package { 'postfix':
  ensure => '2.11.0-1ubuntu1',
}
