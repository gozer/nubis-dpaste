...
package { 'apport':
  ensure => '2.14.1-0ubuntu3.21',
}
package { 'apport-symptoms':
  ensure => '0.20',
}
package { 'apt':
  ensure => '1.0.1ubuntu2.14',
}
...
package { 'klibc-utils':
  ensure => '2.0.3-0ubuntu1.14.04.1',
}
package { 'kmod':
  ensure => '15-0ubuntu6',
}
package { 'kpartx':
  ensure => '0.4.9-3ubuntu7.13',
}
...
package { 'libmysqlclient18':
  ensure => '5.5.50-0ubuntu0.14.04.1',
}
package { 'libncurses5':
