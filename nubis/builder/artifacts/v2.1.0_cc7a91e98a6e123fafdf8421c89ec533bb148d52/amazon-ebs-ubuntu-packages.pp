...
package { 'apparmor':
  ensure => '2.10.95-0ubuntu2.7',
}
package { 'apport':
  ensure => '2.20.1-0ubuntu2.15',
}
...
package { 'dns-root-data':
  ensure => '2015052300+h+1',
}
package { 'dnsmasq':
  ensure => '2.75-1ubuntu0.16.04.4',
}
...
package { 'git':
  ensure => '1:2.7.4-0ubuntu1.3',
}
package { 'git-man':
  ensure => '1:2.7.4-0ubuntu1.3',
}
package { 'gnupg':
  ensure => '1.4.20-1ubuntu3.1',
}
package { 'gpgv':
  ensure => '1.4.20-1ubuntu3.1',
}
...
package { 'libmysqlclient-dev':
  ensure => '5.7.21-0ubuntu0.16.04.1',
}
...
package { 'libpci3':
  ensure => '1:3.3.1-1.1ubuntu1.1',
}
package { 'libpcre3':
  ensure => '2:8.38-3.1',
}
package { 'libperl5.22':
  ensure => '5.22.1-9ubuntu0.2',
}
package { 'libpipeline1':
  ensure => '1.4.1-2',
}
package { 'libplymouth4':
  ensure => '0.9.2-3ubuntu13.2',
}
package { 'libpng12-0':
  ensure => '1.2.54-1ubuntu1',
}
...
package { 'ntp':
  ensure => '1:4.2.8p4+dfsg-3ubuntu5.7',
}
package { 'open-iscsi':
...
package { 'pollinate':
  ensure => '4.25-0ubuntu1~16.04.1',
}
package { 'popularity-contest':
  ensure => '1.64ubuntu2',
}
package { 'postfix':
  ensure => '3.1.0-3ubuntu0.2',
}
...
package { 'vlan':
  ensure => '1.9-3.2ubuntu1.16.04.4',
}
package { 'wget':
  ensure => '1.17.1-1ubuntu1.3',
}
package { 'whiptail':
  ensure => '0.52.18-1ubuntu2',
}
